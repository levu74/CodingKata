...
{
    public class SudokuSolutionValidatorBenchmark : IBestVoteComparisonBenchmark
    {
        ...
        {
            new Kata().ValidateSolution(ValidBoard);
        }

        [Benchmark]
        public void BestVote()
        {
            new KataBestVote().ValidateSolution(ValidBoard);
        }
